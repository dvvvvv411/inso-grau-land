...
const Footer = () => {
  ...
  const socialLinks = [
    { 
      name: 'Facebook', 
      href: 'https://www.facebook.com/Kanzlei.Steinbock.Partner/',
      icon: Facebook
    },
    { 
      name: 'Xing', 
      href: 'https://www.xing.com/pages/steinbock-partner/',
      icon: () => (
    ...
    { 
      name: 'Instagram', 
      href: 'https://www.instagram.com/steinbockundpartner/',
      icon: Instagram
    },
    { 
      name: 'YouTube', 
      href: 'https://www.youtube.com/channel/UCRZcAInBlFNZsl_U8_kxbNw',
      icon: Youtube
    },
    { 
      name: 'LinkedIn', 
      href: 'https://www.linkedin.com/company/steinbock-partner/about/',
      icon: Linkedin
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-4 text-sm">
              <div className="text-blue-100">
                © 2025 Steinbock & Partner. Alle Rechte vorbehalten.
              </div>
              <button
                onClick={() => {
