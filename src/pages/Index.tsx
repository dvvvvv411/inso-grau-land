        ...
        <div className="w-full max-w-7xl mx-auto px-8">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
              Das sagen unsere <span className="text-yellow-400">Mandanten</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Vertrauen und Zufriedenheit unserer Mandanten stehen im Mittelpunkt unserer Arbeit
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Testimonial 1 */}
            <div className="bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-700">
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-6 italic">
                "Ausgezeichnete Beratung im Arbeitsrecht. Herr Steinbock hat unseren Fall mit großer Kompetenz und Engagement bearbeitet. Wir sind sehr zufrieden mit dem Ergebnis."
              </p>
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <p className="text-white font-semibold text-sm">Michael Weber</p>
                  <p className="text-gray-400 text-sm">TechStart GmbH</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-700">
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-6 italic">
                "Professionelle Steuerberatung auf höchstem Niveau. Das Team hat uns durch komplexe Unternehmensstrukturen geführt und dabei immer verständlich erklärt."
              </p>
              <div className="flex items-center gap-4">
                <img 
                  src="https://images.unsplash.com/photo-1494790108755-2616b9c8db5c?w=60&h=60&fit=crop&crop=face"
                  alt="Sarah Müller"
                  className="w-12 h-12 rounded-full object-cover border-2 border-gray-600"
                />
                <div>
                  <p className="text-white font-semibold text-sm">Sarah Müller</p>
                  <p className="text-gray-400 text-sm">Innovate Solutions AG</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-700">
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-6 italic">
                "Schnelle und zuverlässige Unterstützung bei unserem Immobilienerwerb. Die digitale Abwicklung war vorbildlich und hat viel Zeit gespart."
              </p>
              <div className="flex items-center gap-4">
                <img 
                ...
                />
                <div>
                  <p className="text-white font-semibold text-sm">Thomas Schmidt</p>
                  <p className="text-gray-400 text-sm">Baumeister & Co</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-700">
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-6 italic">
                "Hervorragende Beratung im Familienrecht. Einfühlsam, kompetent und immer erreichbar. Vielen Dank für die professionelle Begleitung."
              </p>
              <div className="flex items-center gap-4">
                <img 
                ...
                />
                <div>
                  <p className="text-white font-semibold text-sm">Jennifer Koch</p>
                  <p className="text-gray-400 text-sm">Privatmandat</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-700">
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-6 italic">
                "Erstklassige Rechtsberatung für unser Start-up. Von der Gründung bis zur ersten Finanzierungsrunde - immer verlässlich und vorausschauend."
              </p>
              <div className="flex items-center gap-4">
                <img 
                ...
                />
                <div>
                  <p className="text-white font-semibold text-sm">Martin Bauer</p>
                  <p className="text-gray-400 text-sm">FinTech Pioneers</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-700">
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-6 italic">
                "Kompetente Unterstützung bei der Unternehmensnachfolge. Die Beratung war umfassend und hat uns sehr geholfen, den Übergang erfolgreich zu gestalten."
              </p>
              <div className="flex items-center gap-4">
                <img 
                  src="https://images.unsplash.com/photo-1507101105822-7472b28e22ac?w=60&h=60&fit=crop&crop=face"
                  alt="Andreas Hoffmann"
                  className="w-12 h-12 rounded-full object-cover border-2 border-gray-600"
                />
                <div>
                  <p className="text-white font-semibold text-sm">Andreas Hoffmann</p>
                  <p className="text-gray-400 text-sm">Traditionsbetrieb Hoffmann</p>
                </div>
              </div>
            </div>
          </div>
