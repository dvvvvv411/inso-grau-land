        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            <div 
              ...
              style={{
                backgroundImage: `linear-gradient(135deg, rgba(0, 69, 149, 0.6), rgba(255, 255, 255, 0.1), rgba(0, 86, 179, 0.4)), url('/lovable-uploads/15349153-a75f-48a5-a7a1-3060dddde8cb.png')`
              }}
            >
            </div>
          </div>
