          ...
          <div className="p-8">
            <div className="space-y-8 text-gray-700 leading-relaxed">
              ...
              <div>
                ...
                <p>
                  Rufen Sie uns einfach unverbindlich an oder schreiben Sie uns eine E-Mail an kanzlei@hess-leipzig.de und schildern Sie uns Ihr Anliegen. Gerne können Sie für die Kontaktaufnahme auch unseren Button „Rückruf-Service" nutzen. Gespräche über Kosten kosten nichts.
                </p>
              </div>
            </div>
          </div>
