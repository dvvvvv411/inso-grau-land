        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <div 
              ...
              style={{
                backgroundImage: `linear-gradient(135deg, rgba(0, 69, 149, 0.6), rgba(255, 255, 255, 0.1), rgba(0, 86, 179, 0.4)), url('/lovable-uploads/a90d4293-73bd-4088-893a-fd787049c2e7.png')`
              }}
            >
            </div>
          </div>
